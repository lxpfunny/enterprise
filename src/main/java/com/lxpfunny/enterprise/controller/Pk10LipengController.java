 ...
 */
@RestController
@RequestMapping("/pk10/lipen")
public class Pk10LipengController {
    ...
    public Map<String,String> start(@RequestParam("cookie")  String cookie,@RequestParam("qianType")String qianType,@RequestParam("bei")String bei) {
        ...
        if(StringUtils.isNotEmpty(qianType)){
            Pk10LipengController.qianType = qianType;
        }
        if(StringUtils.isNotEmpty(bei)){
            Pk10LipengController.bei = bei;
        }
...
//        cookie = "__cfduid=d78da6e786da48a75f87e0109b464756a1543198173; ASP.NET_SessionId=alxjwvnluww4iumunqtjuxq0";
            ...
            param.put("action", "1");
            param.put("type", "2");
            param.put("uname", "aaa333");
            param.put("pwd", "aaa333");
            param.put("code", code);
            String resonse = null;
