...
public class HttpUtils {
    ...
    public static String doPost(String url, Map<String, Object> params) throws Exception {
        if (url.startsWith("https://")) {
            ...
            return doPostHttp(url, null, params,null);
        }
    }
    ...
    public static String doPost(String url, Map<String, Object> params,String charSet) throws Exception {
        if (url.startsWith("https://")) {
            ...
            return doPostHttp(url, null, params,charSet);
        }
    }
    ...
    public static String doPost(String url, Map<String, String> headers, Map<String, Object> params) throws Exception {
        if (url.startsWith("https://")) {
            ...
            return doPostHttp(url, headers, params,null);
        }
     ...
     * @return
     */
    public static String doPostHttp(String apiUrl, Map<String, String> headers, Map<String, Object> params,String charSet) throws Exception {
    ...
    public static String doPostMultipart(String apiUrl,Map<String, Object> params) throws Exception {
        return doPostMultipart(apiUrl, null, params, defaultCharSet);
    }
    /**
     * 发送 POST 请求（HTTP）文件流
     *
     ...
     * @return
     */
    public static String doPostMultipart(String apiUrl, Map<String, String> headers, Map<String, Object> params,String charSet) throws Exception {
        CloseableHttpClient httpClient = HttpClients.createDefault();
        String httpStr = null;
        HttpPost httpPost = new HttpPost(apiUrl);
        CloseableHttpResponse response = null;
...
//            List<NameValuePair> pairList = new ArrayList<>(params.size());
            ...
            mEntityBuilder.addBinaryBody("Filedata", (InputStream) params.get("Filedata"), ContentType.MULTIPART_FORM_DATA,"filename");

            for (Map.Entry<String, Object> entry : params.entrySet()) {
                mEntityBuilder.addTextBody(entry.getKey(), String.valueOf(entry.getValue()));
            }
